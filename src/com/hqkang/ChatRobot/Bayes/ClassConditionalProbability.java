...
public class ClassConditionalProbability 
{
    ...
    */
    ...
    {
        float ret = 0F;
        float Nxc = TrainingDataManager.getCountContainKeyOfClassification(c, x);
        float Nc = TrainingDataManager.getTrainingFileCountOfClassification(c);
        float V = TrainingDataManager.getTrainingClassifications().size();
